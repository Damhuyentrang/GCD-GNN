...
public class DataBaseHelper extends SQLiteOpenHelper {
    ...
    public void onCreate(SQLiteDatabase sqLiteDatabase) {
        ...
        String sql1 = "INSERT INTO "+USERS_TABLE+" ("+COLUMN_USERNAME+","+COLUMN_PHONE+","+COLUMN_PASSWORD+","+COLUMN_EMAIL+","+COLUMN_MONEY+") VALUES('DAM THI HUYEN TRANG','0886010204','01022004','damtrang102@gmail.com',100000000)";
        String sql2 = "INSERT INTO "+USERS_TABLE+" ("+COLUMN_USERNAME+","+COLUMN_PHONE+","+COLUMN_PASSWORD+","+COLUMN_EMAIL+","+COLUMN_MONEY+") VALUES('LE VAN HUNG','0812102204','01022004','LVH@gmail.com',100000000)";
